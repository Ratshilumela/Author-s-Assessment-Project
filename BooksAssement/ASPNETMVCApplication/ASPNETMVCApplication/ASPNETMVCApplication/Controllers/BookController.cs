    ...
    public class BookController : Controller
    {
        ...
        public ActionResult Create(FormCollection collection)
        {
            ...
            else
            {
                ...
                book.address = collection["address"].ToString();
                book.city = collection["city"].ToString();
                book.state = collection["state"].ToString();
                book.zip = collection["zip"].ToString();
                book.contract = collection["contract"].ToString();
